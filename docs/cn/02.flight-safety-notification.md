...
* [HMS 功能](https://developer.dji.com/doc/payload-sdk-tutorial/cn/basic-function/hms-customization.html)：使用 HMS 功能，尽量保留飞行全过程的 HMS 错误码记录。

* [本地日志记录](https://developer.dji.com/doc/payload-sdk-tutorial/cn/basic-function/log-management.html)：对于关键的控制飞机的指令、订阅的数据和上电时间戳进行本地记录，便于后续售后问题分析。

* [第三方升级功能](https://developer.dji.com/doc/payload-sdk-tutorial/cn/basic-function/local-update.html)：第三方支持固件升级功能，便于及时进行问题修复和引导客户升级。
