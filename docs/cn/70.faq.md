...
版本迁移主要涉及 Matrice 300 RTK 机型，因其 OSDK 端口和 PSDK 端口独立，且旧版本是独立的开发包。已经在 Matrice 300 RTK 上完成 OSDK 和 PSDK 功能或设备的开发者，需要从旧版本 OSDK 4.X 和 PSDK 2.X 迁移到官方维护的 PSDK 3.X 版本，可以与 DJI SDK版本同步，方便适配 SDK 新增的功能以及后续的版本维护。
...
4. Matrice 300 RTK PSDK2.x开发迁移到PSDK 3.X，需在dji_sdk_config.h设置。
