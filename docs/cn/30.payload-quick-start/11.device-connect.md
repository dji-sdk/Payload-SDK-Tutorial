...
<div>
<div align=center>
<img src="https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/psdk/FC100/FC100%E8%AE%BE%E5%A4%87%E8%BF%9E%E6%8E%A5%E5%9B%BE.png" style="width:65%"/>
</div>
...
## Matrice 400 设备连接
开始Matrice 400 的设备连接前，请先阅读[Matrice 400 用户手册](https://dl.djicdn.com/downloads/Matrice_400/Matrice_400_User_Manual_v1.0_zh-cn.pdf)中的 “部件名称” 并关注飞行器组件的介绍。

Matrice 400说明书更新了FOV说明，具体可参考[Matrice 400 用户手册V1.02](https://dl.djicdn.com/downloads/Matrice_400/UM/20250908/Matrice_400_User_Manual_v1.02_zh-cn.pdf)中的“FOV”部分。
...
按照上图完成连接后，用户可直接基于 E-Port V2 开发板上自带的GD32进行PSDK开发，也可使用E-Port V2开发板的USB接口外接三方开发板进行开发。
Matrice 400上的4号E-Port V2接口支持通过连接Hub来进行扩展。参考[E-Port V2 HUB参考原理图](https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/psdk/M400/hub%E5%8F%82%E8%80%83%E5%8E%9F%E7%90%86%E5%9B%BE%E6%9B%B4%E6%96%B0.pdf)用户可以设计二级Hub，从而通过Hub最多扩展出最多4个E-Port V2接口，拓展出的E-Port V2 接口接方法与原生接口一致。


## Matrice 4E/4T 、Matrice 4D/4TD设备连接
...
OSDK 拓展组件即将停产，推荐使用 E-Port 开发者套件。若想了解 OSDK 拓展组件相关信息，可阅读飞行器硬件接口介绍中的 [OSDK 拓展组件](https://developer.dji.com/doc/payload-sdk-tutorial/cn/payload-quick-start/drone-port.html)。
