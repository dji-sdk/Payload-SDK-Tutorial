...
<table width="100%" style="display: table; table-layout:fixed;">
    ...
    <tbody>
        <tr>
            <td>妙算 3、Matrice 400、Matrice 4TD/4D、Matrice 4T/4E 行业系列及后续机型</td>
        ...
        <tr>
            <td>Matrice 3D/3TD、Matrice 350 RTK、Matrice 300 RTK、Matrice 30 系列、 Mavic 3 行业系列</td>
            <td>PSDK 3.9.2</td>
            <td>✓</td>
            <td>×</td>
        </tr>
...
2025-11-25
### 发布功能列表
- 增加 FlyCart 100 机型支持 E-PORT Lite 口支持
- 增加 FlyCart 100 UART 波特率自适应
- 增加 FlyCart 100 消息订阅功能
- 增加 FlyCart 100 飞行控制功能
- 增加 FlyCart 100 航线模式
- 增加 FlyCart 100 下电通知
- 增加 FlyCart 100 电池数据订阅
- 增加 FlyCart 100 HMS 消息订阅
- 增加 FlyCart 100 无 RC 控制功能
- 支持旗舰空吊控制与状态反馈
...
- 增加 Zenmuse L3 机型支持
- 增加自定义网络 RTK 功能开放
- 增加妙算3搭配 M400 无人机使用 L2 相机
- 增加妙算3搭配 M400 无人机使用远距离飞行打点功能
- 增加妙算3修改开机自启应用
- 增加妙算3软件许可证文档说明

### 修复和优化的功能
- 优化妙算3搭配 M400 使用机载网络功能
...
#### 妙算3 功能支持
- 支持搭载 M4D 系列无人机机场版本，暂不支持 Pilot
- 支持 M4D 系列无人机使用 PSDK 高级功能
- 支持 M400 无人机使用 SDK 互联互通功能
- 支持司空安装卸载妙算3应用
- 支持司空渲染妙算3 AI 应用识别结果

### 修复和优化的功能
- 修复 M300 PSDK 低速数据无法从 P 口发给 O 口问题
- 修复 M350 无人机无法获取 P1 相机及 L1 雷达实时码流问题
...
##### 5.1 Skyport-V2及XPort软件升级
  - 升级了Skyport-V2、XPort软件版本，设备需要挂接在M300或M350上升级到最新软件版本，才能支持在M400机型上使用，后续软件版本的升级可在M400上完成。
...
* 修复在M4D/M4TD E-Port Lite 接口使用时，在司空上不识别的问题。
* 修复使用DjiCore_DeInit接口崩溃的问题。
* 修复M350 RTK使用USB bulk通道传输视频流偶现崩溃的问题。
...
* 增加 DJI SDK 认证芯片（DJI SDK CC）功能支持(关于认证芯片的描述和使用方法可以[点击这里跳转](https://developer.dji.com/doc/payload-sdk-tutorial/cn/payload-quick-start/quick-guide/sdk-cc.html))
...
详情请参见[媒体文件元数据](https://developer.dji.com/doc/payload-sdk-tutorial/cn/advanced-function/media-file-metadata.html)。
