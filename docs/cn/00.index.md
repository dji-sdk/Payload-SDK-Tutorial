...
<table width="100%" style="display: table; table-layout:fixed;">
    ...
    <tbody>
        <tr>
            <td>Matrice 300 RTK、Matrice 30 系列、 Mavic 3 行业系列及后续机型</td>
            <td>PSDK 3.4.0</td>
            <td>√</td>
            <td>√</td>
        </tr>
...
> **说明：** PSDK 支持的机型在后续的文档中，分别简称 M300 RTK、M30/M30T、M3E/M3T。
