    ...
    <div>
        <table width="100%" style=" hyphens: auto; display: table; table-layout:fixed;">
            ...
            <tbody>
                ...
                <tr>
                    <td>三云台信息（适用M300 RTK与M350 RTK，上下三个云台的信息）<br/>*_THREE_GIMBAL_DATA</td>
                    <td>-</td>
                    <td>最大 50Hz</td>
                    <td>-</td>
                    <td>-</td>
  ...
  <table style="margin: 0 auto; border-collapse: collapse; width: 100%;">
    <thead>
      <tr style>
        ...
        <th style="border: 1px solid #ddd; padding: 6px 8px; text-align: left;">参考坐标系</th>
        ...
        <th style="border: 1px solid #ddd; padding: 6px 8px; text-align: left;">可靠度</th>
