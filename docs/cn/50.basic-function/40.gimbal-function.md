...
> **说明：** 使用PSDK 开发负载设备的云台功能时，请使用**SkyPort V2** 或 **SkyPort** ，若您所用的开发工具为X-Port，请阅读[X-Port 功能](https://developer.dji.com/doc/payload-sdk-tutorial/cn/basic-function/x-port-function.html)。
