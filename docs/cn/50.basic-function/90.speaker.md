...
DJI Pilot 2支持显示标准喊话器控件，用户可以通过配置[自定义控件](https://developer.dji.com/doc/payload-sdk-tutorial/cn/basic-function/custom-widget.html)中的喊话器json字段，来控制是否进行图标显示。

注意： 在使用喊话器控件之前，需要先使能[自定义控件](https://developer.dji.com/doc/payload-sdk-tutorial/cn/basic-function/custom-widget.html)。
