...
Waypoint 3.0功能提供了上传航线任务、监控航线状态和控制航线执行动作等功能。相比Waypoint 2.0，可以直接导入标准格式的KMZ文件，通用性和兼容性更好。KMZ格式请参考：[航线文件格式](https://developer.dji.com/doc/cloud-api-tutorial/cn/feature-set/dji-wpml/overview.html)。
