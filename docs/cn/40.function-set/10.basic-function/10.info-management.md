...
### 订阅项
使用 PSDK 消息订阅功能可订阅的数据信息如 表. 飞行器订阅项 所示。**表格中数值为订阅项最大支持的 HZ 值。**
...
<table width="100%" style=" hyphens: auto; display: table; table-layout:fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td>海拔高度<br/>*_ALTITUDE_BAROMETER</td>
            <td>200Hz</td>
            <td>50Hz</td>
            <td>50Hz</td>
            <td>200Hz</td>
        ...
        <tr>
            <td>原点高度<br/>*_ALTITUDE_OF_HOMEPOINT</td>
            <td>1Hz</td>
            <td>50Hz</td>
            <td>5Hz</td>
            <td>1Hz</td>
        ...
        <tr>
            <td>相对高度<br/>*_HEIGHT_RELATIVE</td>
            <td>200Hz</td>
            <td>-</td>
            <td>-</td>
            <td>200Hz</td>
        ...
        <tr>
            <td>GPS 信号等级<br/>*_GPS_SIGNAL_LEVEL</td>
            <td>50Hz</td>
            <td>50Hz</td>
            <td>50Hz</td>
            <td>50Hz</td>
...
### 订阅规则
* 消息订阅功能最多支持订阅 **4 类频率**，如最多支持订阅 10Hz、20Hz、50Hz、100Hz，4 类频率，每个订阅项只能被订阅一次。
...
2. 注册回调函数     
注册回调函数接收飞行器产生并对外推送的数据信息，下述代码以 1Hz 的频率订阅飞行器 “飞行器飞行速度” 和 “飞行器 GPS 坐标”，如 图. 订阅结果（1） 所示。
> **说明：** 使用订阅功能订阅飞行器上的数据信息时，订阅频率只能为” 最大订阅频率 “的约数。
