...
具有[信息管理](https://developer.dji.com/doc/payload-sdk-tutorial/cn/basic-function/info-management.html) 功能的应用程序，能够方便用户获取飞行器基础参数的信息：
...
通过 PSDK 获取的定位相关数据可参考 [数据订阅](https://developer.dji.com/doc/payload-sdk-tutorial/cn/basic-function/info-management.html)。
...
<div style="width:100%; display: flex; flex-direction: column; align-items: center;">
    <div style="text-align: center; margin-bottom: 8px;">表. M300 RTK/M350 RTK 控制权逻辑说明</div>
    <table style="border-collapse: collapse; min-width: 350px;">
    <thead>
      <tr>
        <th>RC 状态</th>
...
控制权被动切换的场景：低电量返航 / 降落、PSDK 异常断联
<div style="width:100%; display: flex; flex-direction: column; align-items: center;">
    <div style="text-align: center; margin-bottom: 8px;">表. M30/M30T/M3E/M3T 控制权逻辑说明</div>
    <table style="border-collapse: collapse; min-width: 350px;">
    <thead>
      <tr>
        <th>RC 状态</th>
