...
表1.云台控制权限  </p></div>
<div>
<table width="30%" style="margin: 0 auto; overflow: auto; table-layout: fixed; text-align: center;">
  <thead>
    <tr>
      <th>权限角色</th>
      <th>权限等级</th>
...
* 机械限位：机械限位由云台类负载设备的物理形态和设计结构决定，详情请参见<a href="../../payload-quick-start/configure-the-hardware-environment/payload-develop-criterion.html" target="_blank" rel="noopener noreferrer">标准声明</a>。
...
:::tip 说明：
 使用PSDK 开发负载设备的云台功能时，请使用**SkyPort V2** 或 **SkyPort** ，若您所用的开发工具为X-Port，请阅读<a href="../../function-overview/basic-function/x-port-function.html" target="_blank" rel="noopener noreferrer">X-Port 功能</a>。
:::
