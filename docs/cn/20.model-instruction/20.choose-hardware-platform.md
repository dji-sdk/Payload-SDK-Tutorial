...
    </tr>
    ...
    <tr>
      ...
      <td>PSDK 3.7.0<br/>Cloud API 1.8.0</td>
      <td>PSDK 3.7.0</td>
...
> * DJI Mavic 3 行业系列仅提供一个 PSDK USB-C 端口用于拓展开发与连接 PSDK 负载，暂无开发配件支持，请用户查阅[硬件参考设计](https://github.com/dji-sdk/Payload-SDK/blob/master/doc/reference_designs/Type-C%20Schematic%20Reference.pdf) 自行开发。
