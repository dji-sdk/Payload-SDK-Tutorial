...
### Subscription Topics
Subscribable data information is shown at Table. Drone Subscription Topics. **The data on the table is the supported maximum HZ value of the subscription topics.**
...
<table width="100%" style=" hyphens: auto; display: table; table-layout:fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td>Fusion attitude<br/>*_ALTITUDE_FUSED</td>
            <td>200Hz</td>
            <td>50Hz</td>
            <td>50Hz</td>
            <td>200Hz</td>
        ...
        <tr>
            <td>Altitude<br/>*_ALTITUDE_BAROMETER</td>
            <td>200Hz</td>
            <td>50Hz</td>
            <td>50Hz</td>
            <td>200Hz</td>
        ...
        <tr>
            <td>Home point height<br/>*_ALTITUDE_OF_HOMEPOINT</td>
            <td>1Hz</td>
            <td>50Hz</td>
            <td>5Hz</td>
            <td>1Hz</td>
        ...
        <tr>
            <td>Fusion height<br/>*_HEIGHT_FUSION</td>
            <td>100Hz</td>
            <td>50Hz</td>
            <td>50Hz</td>
            <td>100Hz</td>
        ...
        <tr>
            <td>Relative height<br/>*_HEIGHT_RELATIVE</td>
            <td>200Hz</td>
            <td>-</td>
            <td>-</td>
            <td>200Hz</td>
        ...
        <tr>
            <td>Fusion position<br/>*_POSITION_FUSED</td>
            <td>200Hz</td>
            <td>-</td>
            <td>-</td>
            <td>200Hz</td>
