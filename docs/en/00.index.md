...
<table width="100%" style="display: table; table-layout:fixed;">
    ...
    <tbody>
        <tr>
            <td>Manifold 3, Matrice 400, Matrice 4TD/4D, Matrice 4T/4E Enterprise Series and subsequent models</td>
            <td><a href="https://github.com/dji-sdk/Payload-SDK/releases" target="_blank">Latest version of PSDK</a></td>
            <td>✓</td>
            <td>✓</td>
        </tr>
        <tr>
            <td>FlyCart 30, FlyCart 100</td>
            <td>PSDK 3.14.1</td>
            <td>✓</td>
            <td>✓</td>
        </tr>
        ...
        <tr>
            <td>Matrice 3D/3TD, Matrice 350 RTK, Matrice 300 RTK, Matrice 30 Series, Mavic 3 Enterprise Series</td>
            <td>PSDK 3.9.2</td>
            <td>✓</td>
            <td>×</td>
        </tr>
