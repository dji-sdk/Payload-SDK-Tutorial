...
> **Note:** When using PSDK to develop the gimbal function of the payload device, please use **SkyPort V2** or **SkyPort**, if the development tool you use is X-Port, please read [X-Port Function](https://developer.dji.com/doc/payload-sdk-tutorial/en/basic-function/x-port-function.html).
