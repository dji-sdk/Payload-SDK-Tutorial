...
* [HMS Function](https://developer.dji.com/doc/payload-sdk-tutorial/en/basic-function/log-management.html): When using the Health Management System (HMS) function, maintain a detailed record of HMS error codes throughout the flight.

* [Log Management](https://developer.dji.com/doc/payload-sdk-tutorial/en/basic-function/log-management.html): Record crucial aircraft control commands, subscribed data, and power-on timestamps to aid post-sale troubleshooting.

* [Local Update](https://developer.dji.com/doc/payload-sdk-tutorial/en/basic-function/local-update.html): Support third-party firmware upgrade, enabling timely bug fixes and guiding customers through the upgrade process.
