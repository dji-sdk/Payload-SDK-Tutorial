...
:::tip Note:
 This feature applies to the M400 paired with Manifold 3.
:::
...
:::tip Note:
 The callback registered via this interface receives the operational status resulting from calling `DjiNetworkRtk_StartService`. Use it to monitor the RTK service state and take required actions.
:::
