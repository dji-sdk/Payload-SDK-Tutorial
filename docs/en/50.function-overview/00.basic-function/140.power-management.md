...
```
The DJI Manifold 3 connected to the EPROT port of the Matrice 400 supports using the `DjiPowerManagement_OutputHighPower(true)` interface to output 14V high voltage to the load via the USB port.
