...
:::tip Note: 
The target point of M300 RTK is the center point of the upper surface of the load device adapter ring, and the load device needs to be mounted on the drone No. 1 gimbal.
