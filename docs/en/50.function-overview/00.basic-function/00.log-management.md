...
:::tip Note:
 This tutorial takes "Using STM32 to print log information through serial port on RTOS system" as an example to introduce the method and steps of using the log management function.
:::
...
:::tip Note:
 The payload device developed with PSDK supports up to **8** log printing methods at the same time.
:::
...
<div style="width: 80%; margin: 0 auto; text-align: center;">
  <p>Figure 1. Log information</p>
  <p>
    <img
      src="https://terra-1-g.djicdn.com/84f990b0bbd145e6a3930de0c55d3b2b/admin/doc/51cf3014-45f3-42ba-85b4-5e24c1b92f03.png"
...
:::tip Note:
 The level of the log is Info, so the logs of type Info, Warn and Error in the payload device will be output on the terminal, and the log of type Debug will not be printed out.
:::
