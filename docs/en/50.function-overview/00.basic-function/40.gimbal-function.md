...
:::tip Note:
 In the above three modes, other modules in the drone system (gimbal control commands during flight), the remote controller and the Mobile App can control the rotation of the gimbal.
:::
...
* Mechanical limit: The mechanical limit is determined by the physical form and design structure of the gimbal-type load device. For details, please refer to <a href="../../payload-quick-start/configure-the-hardware-environment/payload-develop-criterion.html" target="_blank" rel="noopener noreferrer">Standard Statement</a>.
...
:::tip Note:
 When using PSDK to develop the gimbal function of the payload device, please use **SkyPort V2** or **SkyPort**, if the development tool you use is X-Port, please read <a href="../../function-overview/basic-function/x-port-function.html" target="_blank" rel="noopener noreferrer">X-Port Function</a>.
:::
