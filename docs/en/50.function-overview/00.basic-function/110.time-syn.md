...
:::tip Note:
 Before using the time synchronization function, please use the Mobile App to confirm that the drone and RTK satellite maintain a good communication status; the Mobile App can be an APP released by DJI, such as DJI Pilot, or The Mobile App developed based on MSDK is shown in Figure 1. Viewing satellite communication status.
:::
<div>
<div style="text-align: center"><p>Figure 1. View satellite communication status</p>
</div>
<div style="text-align: center"><p><span>
<img src="https://terra-1-g.djicdn.com/84f990b0bbd145e6a3930de0c55d3b2b/admin/doc/93069b77-81e4-419d-ae39-6fba08a41737.png" style="max-width: 80%; height: auto;"></span></p>
</div></div>
