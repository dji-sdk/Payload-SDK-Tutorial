:::tip Note:
* Before using the X-Port control function, please follow the [User's Guide](https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/psdk/DJI%20ENTERPRISE%20X-Port%20user%20manual.pdf), according to <a href="../../payload-quick-start/configure-the-hardware-environment/payload-develop-criterion.html" target="_blank" rel="noopener noreferrer">Load Standard</a> and <a href="../../payload-quick-start/configure-the-hardware-environment/device-connect.html" target="_blank" rel="noopener noreferrer">Port Description</a> requirements and instructions, reasonably design payload device, and use X-Port correctly.
* Before using X-Port to develop payload devices, please read the <a href="../../function-overview/basic-function/gimbal-function.html" target="_blank" rel="noopener noreferrer">Gimbal Function</a> tutorial to learn about the basic concept of controlling gimbal rotation.
...
## Overview
DJI X-Port standard gimbal  is a hardware platform for developing payload devices. Users can use X-Port to quickly develop payload devices with gimbal  functions; combined with <a href="./custom-widget.html" target="_blank" rel="noopener noreferrer">custom widget</a> function, using DJI Pilot and apps developed based on MSDK can also display the controls designed by the developer, which is convenient for users to control the use of X-Port standard gimbal and PSDK through the controls developed load device.
...
### X-Port Control
 X-Port standard gimbal  integrates the basic functions of gimbal . For details, please refer to <a href="../../function-overview/basic-function/gimbal-function.html" target="_blank" rel="noopener noreferrer">Gimbal Function</a>.
...
<div style="width:100%; display: flex; flex-direction: column; align-items: center;">
    <div style="text-align: center; margin-bottom: 8px;">Table 1. X-Port Control Permissions</div>
    <table style="border-collapse: collapse; min-width: 350px;">
        <thead>
            <tr>
                <th style="text-align: left;">Permission roles</th>
                <th style="text-align: left;">Privilege Level</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td style="text-align: left;">Use the remote control gimbal joystick to control the X-Port</td>
                <td style="text-align: left;">1</td>
            </tr>
            <tr>
                <td style="text-align: left;">Control X-Port angle through MSDK interface</td>
                <td style="text-align: left;">1</td>
            </tr>
            <tr>
                <td style="text-align: left;">Controlling the X-Port via DJI Pilot</td>
                <td style="text-align: left;">2</td>
            </tr>
            <tr>
                <td style="text-align: left;">Controlling X-Port through load coordination function</td>
                <td style="text-align: left;">2</td>
            </tr>
            <tr>
                <td style="text-align: left;">Control X-Port speed through MSDK interface</td>
                <td style="text-align: left;">2</td>
            </tr>
            <tr>
                <td style="text-align: left;">Controlling the X-Port by flight route</td>
                <td style="text-align: left;">2</td>
            </tr>
            <tr>
                <td style="text-align: left;">Controlling the angle of X-Port via PSDK</td>
                <td style="text-align: left;">2</td>
            </tr>
            <tr>
                <td style="text-align: left;">Controlling speed of X-Port via PSDK</td>
                <td style="text-align: left;">2</td>
            </tr>
        </tbody>
    </table>
...
:::tip Note:
 X-Port only supports users to use DJI Pilot and PSDK to set the speed conversion factor of X-Port.
:::
...
<div style="width:100%; display: flex; flex-direction: column; align-items: center;">
    <div style="text-align: center; margin-bottom: 8px;">Table 2. X-Port Limit Angle</div>
    <table style="border-collapse: collapse; min-width: 350px;">
        <thead>
            <tr>
                <th style="text-align: left;">Limit Angle Type</th>
                <th style="text-align: left;">Default upper limit</th>
                <th style="text-align: left;">Maximum adjustable range</th>
                <th style="text-align: left;">Default lower limit</th>
                <th style="text-align: left;">Lower limit adjustable range</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td style="text-align: left;">Pitch axis joint angle</td>
            ...
            <tr>
                <td style="text-align: left;">Roll axis joint angle</td>
            ...
            <tr>
                <td style="text-align: left;">Pan axis joint angle</td>
            ...
            <tr>
                <td style="text-align: left;">Euler angle of pitch axis</td>
            ...
            <tr>
                <td style="text-align: left;">Extended pitch axis Euler angles</td>
                <td style="text-align: left;">30°</td>
                <td style="text-align: left;">30° ~ 0</td>
            ...
            <tr>
                <td style="text-align: left;">Eulerian Angles for Roll Axis</td>
                <td style="text-align: left;">20°</td>
                <td style="text-align: left;">Not adjustable</td>
                <td style="text-align: left;">-20°</td>
                <td style="text-align: left;">Not adjustable</td>
            </tr>
        </tbody>
...
:::tip Note:
 Except that the range of "Eulerian Angle of Roll Axis" cannot be modified, the range of other types of limit angles can be adjusted according to actual use needs.
:::
...
:::tip Note:
 In the following code, the angle unit of X-Port is 0.1 degree.
:::

<div style="width:100%; display: flex; flex-direction: column; align-items: center;">
    <div style="text-align: center; margin-bottom: 8px;">Table 3. X-Port limit angle</div>
    <table style="border-collapse: collapse; min-width: 350px;">
        <thead>
            <tr>
                <th>Category</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Mounted on I gimbal: 30 (upper limit), -150 (lower limit)<br> Mounted on gimbal II: 150 (upper limit), -30 (lower limit)</td>
            </tr>
        </tbody>
    </table>
</div>
...
<div style="width: 80%; margin: 0 auto; text-align: center;">
  <p>Figure 3. X-Port limit angle</p>
  <p>
    <img
...
* For the detailed description of X-Port working mode, please refer to <a href="../../function-overview/basic-function/gimbal-function.html" target="_blank" rel="noopener noreferrer">Gimbal Function</a>.
...
:::tip Note:
 Before executing the coaxiality detection function, please perform the balance detection first, and ensure that the balance of the X-Port is good.
:::
