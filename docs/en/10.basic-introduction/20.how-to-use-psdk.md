...
<tbody>
  ...
  <tr>
   ...
   <td style="text-align:center"><a href="https://developer.dji.com/doc/payload-sdk-tutorial/en/payload-quick-start/run-sample-code.html">5.Using Sample</a></td>
   <td style="text-align:center"><a href="https://developer.dji.com/doc/payload-sdk-tutorial/en/payload-quick-start/develop-notice.html">6.Develop And Produce</a></td>
...
* Before using PSDK to develop payload devices, please read the content in [Development Instructions](https://developer.dji.com/doc/payload-sdk-tutorial/en/payload-quick-start/develop-notice.html) to avoid damage the payload or drone due to improper operation.
* [Installation](https://developer.dji.com/doc/payload-sdk-tutorial/en/payload-quick-start/config-develop-environment.html) Develop PSDK software, prepare related tool chains and libraries.
* [Connect](https://developer.dji.com/doc/payload-sdk-tutorial/en/payload-quick-start/device-connect.html) drones, hardware platforms, third-party development boards and computers.
* Through [Cross-platform porting](https://developer.dji.com/doc/payload-sdk-tutorial/en/payload-quick-start/porting.html) (optional), port the load device control program developed based on PSDK to different on software and hardware platforms.
* [Compile](https://developer.dji.com/doc/payload-sdk-tutorial/en/payload-quick-start/run-sample-code.html) sample code by running the sample program and understand the method of realizing various functions of PSDK.


#### Develop a fully functional payload
* Please follow the [Practical Tutorial](https://developer.dji.com/doc/payload-sdk-tutorial/en/basic-function/log-management.html) and [PSDK API Documentation](https://developer.dji.com/doc/payload-sdk-api-reference/en/) to develop payload devices.
...
* Please apply for application certification at DJI Developer Website -> Personal Center -> Application Details -> Application Certification.

<div>
  <p>
    <span>
      <img src="https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/psdk/M400/%E9%87%8F%E4%BA%A7%E8%AE%A4%E8%AF%81en.png" width="800" alt=""/>
    </span>
  </p>
</div>
...
## 4. Develop Manifold Application

#### Preparation before development
Manifold applications are software solutions developed for Manifold 3 using DJI PSDK interfaces. Before development, we recommend to learn PSDK fundamentals and Manifold specifications and complete the follow steps:

* Register as a SDK Developer
* Create Payload SDK-Manifold 3 Application
<div align=center>
<img src="https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/psdk/app_mgr/%40%401752239968049.png" width=400 style="height:auto"/>
</div>

* Download latest PSDK package from Payload-SDK repository

#### Start developing manifold application
Reference these key resources during development:
* Refer to [Manifold Hardware Connection](https://developer.dji.com/doc/payload-sdk-tutorial/en/manifold-quick-start/manifold-connect.html) for properly connect Manifold 3 and DJI drones.
* Refer to [Manifold Development Environment](https://developer.dji.com/doc/payload-sdk-tutorial/en/manifold-quick-start/manifold-devlopment.html) for config Manifold development environment
* Compile and run sample programs

#### Develop a fully functional manifold application
Enhance your application using:
- [Manifold3 Quick Start](https://developer.dji.com/doc/payload-sdk-tutorial/en/manifold-quick-start/manifold-dpk.html)
- [Basic Function](https://developer.dji.com/doc/payload-sdk-tutorial/en/basic-function/log-management.html)
- [Advanced Function](https://developer.dji.com/doc/payload-sdk-tutorial/en/advanced-function/media-file-metadata.html)

#### Apply for manifold application certification and enable mass production
By default, manifold application is restricted to be installed on a maximum of 20 manifold devices, to lift this restriction, please apply for application certification at DJI Developer Website -> Personal Center -> Application Details -> Application Certification：

<div align=center>
<img src="https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/psdk/app_mgr/%40%401752240091789.png" width=800 alt="Certification Interface"/>
</div>
