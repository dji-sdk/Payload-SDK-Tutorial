...
* Power Output:
  ...
  * The aircraft has no voltage output ability. It can only detect the presence or absence of external voltage. USB_ VBUS pin (A7) receives the input of external voltage.
