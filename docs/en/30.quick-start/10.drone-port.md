...
The FlyCart 30 model provides an E-Port Lite interface, which serves as the aircraft's USB-C calibration port. This interface's dimensions and pin definitions align with the USB Type-C standard.
...
<table width="100%" style="display: table; table-layout:fixed; text-align:center">
    ...
    <tbody>
        ...
        <tr>
            <td>10</td>
            <td>USB ID Switch</td>
            <td>Switch the host or device of aircraft USB. M300 RTK switches to Host, other models switch to Device.</td>
        </tr>
    </tbody>
</table>
</div>
