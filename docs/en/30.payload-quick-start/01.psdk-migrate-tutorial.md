...
Retrieve app_id and app_key details from the [link](https://developer.dji.com/doc/payload-sdk-tutorial/cn/payload-quick-start/run-sample-code.html) under "Creating a Payload Application".
