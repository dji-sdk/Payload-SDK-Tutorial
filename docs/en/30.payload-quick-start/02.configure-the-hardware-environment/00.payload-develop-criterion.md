...
###  Tethered Battery
The Matrice 400 tethered battery uses a [Chogori KR2+6 connector](https://www.chogori-tech.com/product/info.aspx?itemid=517&lcid=48) for power supply. The connector structure is shown in the diagram for reference. Note that the KR2+6 connector is only open for the definition of positive and negative poles of the power supply, and this power connector supports dud-proof operation, which needs to be Strictly follow the red color for positive pole and black color for negative pole for wiring. When operating in tethered mode, the remaining length of the tether cable can be communicated to the Matrice 400 via PSDK. If the remaining cable length is insufficient, the aircraft will stop responding to throttle commands to ensure flight safety.Note that in order to use the PSDK tethered battery function, you need to use the E-Port V2 coaxial cable for payload development.
...
<div style="text-align: center"><p>Figure. Matrice 400 Tethered Battery Power Supply Interface</p></div>
</div>
