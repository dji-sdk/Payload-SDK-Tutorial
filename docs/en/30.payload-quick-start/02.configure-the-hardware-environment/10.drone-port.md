...
We introduce the standard hardware ports and corresponding development kits, and provide the pins definition and function description. Please be familiar with the aircraft hardware ports and corresponding development kits first, then read the <a href="./device-connect.html" target="_blank">Device Connection</a>.

:::tip
- The E-port of Mavic 3E/3T and Matrice 30/30T corresponds to the PSDK port on the aircraft model User manual.
    ...
    <div>
        <table width="100%" style="display: table; table-layout:fixed; text-align:center">
            <tr>
                ...
                <th>E-Port Name</th>
                <th>Compatible Development Kit</th>
            ...
            <tr>
                ...
                <td>
                    <a href="https://store.dji.com/cn/product/dji-e-port-v2-coaxial-cable-kit?vid=192711" target="_blank" rel="noopener noreferrer">
                        E-Port V2 coaxial cable
                    </a><br/>
                    <a href="https://store.dji.com/cn/product/dji-skyport-v3-adapter-set?vid=192891" target="_blank" rel="noopener noreferrer">
                        SkyPort V3 Adapter Ring
                    </a><br/>
                    <a href="https://store.dji.com/cn/product/dji-skyport-v3-coaxial-cable-kit?vid=192861" target="_blank" rel="noopener noreferrer">
                        SkyPort V3 coaxial cable
                    </a><br/>
                    <a href="https://store.dji.com/cn/product/dji-x-port" target="_blank" rel="noopener noreferrer">
                        X-Port Standard Payload Gimbal
                    </a><br/>
                    <a href="https://store.dji.com/cn/product/dji-e-port-v2-development-kit?vid=191751" target="_blank" rel="noopener noreferrer">
            ...
            <tr>
                ...
                <td>
                    <a href="https://store.dji.com/cn/product/dji-e-port-development-kit" target="_blank" rel="noopener noreferrer">
                        E-Port Development Kit
                    </a><br/>
                    <a href="https://store.dji.com/cn/product/dji-sdk-certified-chip?vid=190941" target="_blank" rel="noopener noreferrer">
                        SDK Certified Chip
                    </a>
                </td>
                <td>√</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    SDK round ribbon cable combo<br/>
                    PSDK quick release bracket
                </td>
                <td>-</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    SkyPort V2 Production Combo<br/>
                    <a href="https://store.dji.com/cn/product/dji-x-port" target="_blank" rel="noopener noreferrer">
                        X-Port Standard Payload Gimbal
                    </a>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    SDK round ribbon cable combo<br/>
                    <a href="https://store.dji.com/cn/product/matrice-300-rtk-osdk-expansion-module" target="_blank" rel="noopener noreferrer">
            ...
            <tr>
                ...
                <td>
                    ...
                    SkyPort V1 Development Kit<br/>
                    SkyPort V1 Production Combo
                </td>
                <td>√</td>
            </tr>
        </table>
...
<div style="margin-top: 16px; width: 60%; margin-left: auto; margin-right: auto; display: flex; flex-direction: column; align-items: center;">
    <table style="border-collapse: collapse; text-align: left; min-width: 600px;">
        <thead>
            <tr>
        ...
        <tbody>
            <tr>
                <td style="font-weight:bold;">Structure Form</td>
                <td>Type C Plug, only M350/M30 supports foolproof design</td>
                <td>Type C Receptacle, supports foolproof design, waterproof, and enhanced vibration disconnection.</td>
            </tr>
            <tr>
                <td style="font-weight:bold;">Interface Definition</td>
                <td>UART, USB, PPS, Online</td>
                <td>Removed UART, added USB 3.0, retained PPS and Online signals</td>
            </tr>
            <tr>
                <td style="font-weight:bold;">Function Support</td>
                <td>
                    UART uses PSDK protocol and small data communication<br>
                    USB supports stream acquisition, perception grayscale image acquisition, MOP function, media file management
                </td>
                <td>
                    1. Supports HUB expansion (M400 E4 interface can expand from 1 to 4, supporting multiple payload access)<br>
                    2. USB 2.0 supports USB‑TTL chip or USB VCOM communication<br>
                    3. All communication links use USB interface<br>
                    4. Supports USB 3.0, enabling simultaneous acquisition of 4K streams, perception grayscale images, and radar point cloud data
                </td>
            </tr>
            <tr>
                <td style="font-weight:bold;">Power Support</td>
                <td>Follows aircraft power</td>
                <td>All four M400 E‑Port V2 ports support 120W continuous power output</td>
            </tr>
        </tbody>
    </table>
    <div style="text-align: center; margin-top: 8px;">
        Table. Differences between E‑Port and E‑Port V2
    </div>
</div>


E‑Port V2 coaxial cable interface definition is as follows:
:::tip Note:
The interface definition of the SkyPort V3 coaxial cable is the same as that of the E‑Port V2 coaxial cable.
:::
<div style="margin-top: 16px; width: 60%; margin-left: auto; margin-right: auto; display: flex; flex-direction: column; align-items: center;">
    <table style="border-collapse: collapse; text-align: left; min-width: 600px;">
        <thead>
...
The interface supports the USB 2.0 to Serial Communication Protocols and supports some of the PSDK V3 software features. For a detailed list of features please refer to the *Aircraft Type Function Difference* in <a href="../../development-preparation/development-platform-overview/open-capability-list.html" target="_blank" rel="noopener noreferrer">Open Capability List</a>.
...
:::tip Note:
The baud rates of serial port supported by M350 RTK gimbal ports are 115200, 230400, 460800, 921600.
:::
### SkyPort V2
...
::warning Note:
 Please use the specified cable to connect the X-Port and the Expansion Board. It should be confirmed that the red cable is aligned with the dot mark, otherwise, the payload may be burned.
:::
...
:::tip Note:
 When using [X-Port standard gimbal](https://store.dji.com/product/dji-x-port) to develop payload device with gimbal function, accessories in Payload SDK Development Kit 2.0 can be adapted to third-party platforms.
:::

<div>
    <div>
        <table width="60%" style="margin: 0 auto; display: table; table-layout:fixed; text-align:center">
            <thead>
                <tr>
                    <th>Pin Number</th>
                    <th>Function</th>
...
<div>
    <div>
        <table width="80%" style="margin: 0 auto; display: table; table-layout:fixed; text-align:center" class="all-left">
            <thead>
                <tr>
                    <th width="10%">Interface number</th>
                    <th width="20%" >Interface type</th>
                    <th width="10%">Pin Name</th>
...
:::tip Note:
 The baud rates of serial port supported by M300 RTK OSDK Port are 115200, 230400, 460800, 921600 and 1000000.
:::
